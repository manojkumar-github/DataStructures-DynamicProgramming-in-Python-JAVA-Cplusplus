...
class PythonDict(object):
    ...
    def get_movie_count(self, hero):
        ...
        """
        # you can have duplicate keys. keys are like hash values which are
        # always unique in dict. Above function get_heros() may have 
        # duplicate values, but this function will return a uniqe vakye
        pass
